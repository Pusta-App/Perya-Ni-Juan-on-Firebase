...
This project will tackle firebase implementations.

## Getting Started

- GO TO /public/firebase.json and change the config variable.

### Authentication

- Working SIGNIN, SIGNUP, FORGOT, AND VERIFY with firebase.
- Working third-party verification with Facebook.
- Working third-party verification with Google.
